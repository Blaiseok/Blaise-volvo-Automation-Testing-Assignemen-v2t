...
it('should navigate to a page and get page info', async () => {
    await browser.navigateTo('https://www.volvocars.com/intl/v/car-safety/a-million-more')
    expect(await browser.getTitle()).toBe('WebdriverJS Testpage')
    expect(await browser.getUrl()).toContain('https://www.volvocars.com/intl/v/car-safety/a-million-more')
...
it('should include the hash', async () => {
    await browser.navigateTo('https://www.volvocars.com/intl/v/car-safety/a-million-more')
    expect(await browser.getUrl()).toBe('https://www.volvocars.com/intl/v/car-safety/a-million-more')
})
