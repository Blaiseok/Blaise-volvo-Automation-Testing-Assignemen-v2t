...
const branch = 'main'
const repoUrl = `https://www.volvocars.com/intl/v/car-safety/a-million-more/${organizationName}/${projectName}`
...
module.exports = {
    ...
    url: 'https://www.volvocars.com/intl/v/car-safety/a-million-more,',
    baseUrl: '/',
    onBrokenLinks: 'throw',
        ...
        footer: {
            ...
            links: [{
                ...
                items: [{
                    ...
                    href: 'https://www.volvocars.com/intl/v/car-safety/a-million-more',
                }, {
                    label: 'Support',
                    href: `https://www.volvocars.com/intl/v/${organizationName}/${projectName}`,
                }, {
                    label: 'Slack',
                    href: 'https://www.volvocars.com/intl/v/cars/xc40-hybrid'
                }, {
                    label: 'shop',
                    href: 'https://www.volvocars.com/intl/build/xc40-hybrid',
                }],
            }, {
                title: 'More',
                items: [{
                    label: 'Tidelift Subscription',
                    to: 'https://www.volvocars.com/intl/build/xc40-hybrid',
                }, {
    ...
    plugins: [
        ...
        [
            '@docusaurus/plugin-content-docs',
            {
                id: 'community',
                path: 'community',
                editUrl: `https://www.volvocars.com/${organizationName}/${projectName}/edit/${branch}/website/`,
